...
import com.xebia.builder.ItemBuilder;
...
public class RobotTest {
    ...
    public void barCodeScanReturns20() {
        ...
        Item item = itemBuilder.withBarCode("5555").withName("Some name").get();
        r.scan(item);
    ...
    public void barCodeScanReturns40() {
        Item item = itemBuilder.withBarCode("88888").withName("Some other name").get();
        r.scan(item);
